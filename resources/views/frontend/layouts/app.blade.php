                      ...
                      <div class="dropdown-menu">
                              ...
                              @foreach(session('cart') as $id => $details)
                                  <div class="row cart-detail">
                                      <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                        <img src="{{ url('uploads/'.$details['image']) }}" alt="image" width="100" height="100" class="img-responsive">
                                      </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                                  <a href="{{ route('frontend.show-all-cart') }}" class="btn btn-primary btn-block">View all</a>
                              </div>
                          </div>
                      </div>
                  </div>
