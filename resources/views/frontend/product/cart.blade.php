...
@section('content')
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    ...
                    <td data-th="Subtotal" class="text-center">{{ number_format($total , '0', ',', '.') }}&nbsp;VND</td>
        ...
        <tfoot>
        <tr class="visible-xs">
            <td class="text-center"><strong>Total {{ number_format($total , '0', ',', '.') }}&nbsp;VND</strong></td>
        </tr>
        <tr>
            <td><a href="{{ url('/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
            <td colspan="2" class="hidden-xs"></td>
            <td class="hidden-xs text-center"><strong>Total {{ number_format($total , '0', ',', '.') }}&nbsp;VND</strong></td>
        </tr>
        </tfoot>
    </table>
    <hr>
